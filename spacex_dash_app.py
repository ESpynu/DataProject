...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        fig=px.pie(filtered_df,values='class count',names='class',title=f"All launches at site {entered_site}")
        return fig
...
def get_scatter_chart(entered_site, payload_slider):
    ...
    if entered_site == 'ALL':
        ...
        plot = px.scatter(data_frame=filtered_df, x="Payload Mass (kg)", y="class", color="Booster Version Category")
        return plot
    else:
        filtered_df = spacex_df[spacex_df['Launch Site'] == entered_site]
